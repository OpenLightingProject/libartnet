...
#define ARTNET_ADDRESS_NO_CHANGE	0x7f
...
extern int artnet_set_handler(artnet_node vn, artnet_handler_name_t handler, int (*fh)(artnet_node n, void *pp, void * d), void* data) ;
extern int artnet_set_dmx_handler(artnet_node vn, int (*fh)(artnet_node n,int port, void *d), void *data );
extern int artnet_set_program_handler(artnet_node vn, int (*fh)(artnet_node n, void *d), void *data );
extern int artnet_set_firmware_handler(artnet_node vn, int (*fh)(artnet_node n, int ubea, uint16_t *data, int length, void *d), void *data );
extern int artnet_set_rdm_handler(artnet_node vn, int (*fh)(artnet_node n, int address, uint8_t *rdm, int length, void *d), void *data ) ;
extern int artnet_set_rdm_initiate_handler(artnet_node vn, int (*fh)(artnet_node n, int port, void *d), void *data ) ;
extern int artnet_set_rdm_tod_handler(artnet_node vn, int (*fh)(artnet_node n, int port, void *d), void *data ) ;

	
// send functions
extern int artnet_send_poll(artnet_node n, const char *ip, artnet_ttm_value_t talk_to_me) ;
extern int artnet_send_poll_reply(artnet_node n) ;
extern int artnet_send_dmx(artnet_node n, int port_id, int16_t length, uint8_t *data) ;
extern int artnet_raw_send_dmx(artnet_node vn, uint8_t addr, int16_t length, uint8_t *data) ;
extern int artnet_send_address(artnet_node n, artnet_node_entry e,const char *shortName, const char *longName, uint8_t inAddr[ARTNET_MAX_PORTS], uint8_t outAddr[ARTNET_MAX_PORTS], uint8_t subAddr, artnet_port_command_t cmd ) ;

extern int artnet_send_input(artnet_node n, artnet_node_entry e, uint8_t settings[ARTNET_MAX_PORTS]) ;

extern int artnet_send_firmware(artnet_node vn, artnet_node_entry e, int ubea, uint16_t *data, int length, int (*fh)(artnet_node n, artnet_firmware_status_code code, void *d), void *user_data ) ;
extern int artnet_send_firmware_reply(artnet_node vn, artnet_node_entry e, artnet_firmware_status_code code) ;
...
extern int artnet_set_port_type(artnet_node n, int id, artnet_port_settings_t settings, artnet_port_data_code data ) ;
extern int artnet_set_port_addr(artnet_node n, int id, artnet_port_dir_t dir, uint8_t addr) ;
extern int artnet_get_universe_addr(artnet_node n, int id, artnet_port_dir_t dir) ;
